 ...
 *
 */
app.utils.convert.toBySetting = function(source, arrFrom, arrTo) {
 ...
 *
 */
app.utils.convert.toZenkaku = function(selectorStr, arrFrom, arrTo) {
  $(selectorStr).change(function() {
    var value  = $(this).val();
    var converted = value.replace(/[A-Za-z0-9]/g, function(s){
      return String.fromCharCode(s.charCodeAt(0) + 0xFEE0);
    });
    if (arrFrom !== undefined) converted = app.utils.convert.toBySetting(converted, arrFrom, arrTo);
    $(this).val(converted);
  });
};
 ...
 *
 */
app.utils.convert.toHankaku = function(selectorStr) {
  $(selectorStr).change(function() {
    var value  = $(this).val();
